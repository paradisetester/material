...
function createCategories(arr) {
    ...
    var html = '<li class="tab col"><a  data-id="' + arr.id + '"  data-slug="' + arr.slug + '" class="hexa colorbox2 blue1 ' + arr.colour + '"><div class="round-txt">\
...
function createsubCategories(arr) {
    ...
    var html = '<a data-id="' + arr.id + '" class="waves-effect  btn-small waves-light btn all-btn all-btn-clr1  cat_' + arr.cat_id + ' ' + arr.colour + '">' + arr.id+' '+arr.name + '</a>';
    HTML1.push(html);
}
         ...
         <div class="demo-card  ' + categorydata[arr.company] + ' ' + typeClass + '-based" data-color="' + categorydata[arr.company] + '" data-date="' + arr.year_fil + '">\
            <div class="panel">\
               <div class="card white front  box "><span class="tri-div">' + arr.company_name.charAt(0) + '</span>\
                  <div class="card-content white-black center colour1 box_top gradient1">\
